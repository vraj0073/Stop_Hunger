...
export const Registration = () => {
  ...
  const validsubmit= (e) =>{
    ...
    return (
      <>  
      <Row  style={{ backgroundImage: `url(${backgroundcontainer})`, backgroundRepeat:'no-repeat',backgroundSize:'cover' }}>
        <Col >
        <h1  style={{color : 'orange', fontFamily: 'serif',paddingTop: '30%',paddingLeft:'10%'}}>Welcone</h1>
        <h1  style={{color : 'white', fontFamily: 'serif',paddingLeft:'10%'}}>To Saveit</h1>
        </Col>
        <Col>
      <div>
     <Container className='registrationcontainer'  style={{ backgroundImage: `url(${background})`, backgroundRepeat:'no-repeat',backgroundSize:'cover' }} >
         
     <Form noValidate validated={validated} className='registrationbox' onSubmit={validsubmit}>
     <h1 id='registrationheading' style={{color : 'white', fontFamily: 'serif'}}>Registration</h1>
     <div>
  ...
  <Form.Group className="mb-3" controlId="formBasicEmail">
    ...
    <Form.Control type="email" onChange={validemail} placeholder="Enter email"  required/>
    <div>
    <small id="passwordHelpBlock" className="error-label form-text text-muted">
  {Emailmessage}</small>
  </div>
  ...
  <Form.Group className="mb-3" controlId="formBasicPassword">
    ...
    <Form.Control required type="text" onChange={validatephone}  placeholder="Phone Number" />
    <div>
    <small id="passwordHelpBlock" className="error-label form-text text-muted">
  {Phonemessage}</small>
  </div>
  ...
  <Form.Label style={{color : 'white'}}> Address
  </Form.Label>
  <Form.Control required as="textarea" rows="3" placeholder="Address" onChange={validateaddress}/>
</Form.Group>
<br></br>
<div style={{color : 'white'}}>Register as : {''}
      <select required onChange={validateRole} defaultValue="Select Role">
        <option required defaultValue  >Select Role</option>
        <option required value="RESTURANT" >Resturant</option>
        <option required value="NGO" >NGO</option>
        </select>
        </div>
